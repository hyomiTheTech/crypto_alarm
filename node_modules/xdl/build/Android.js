...
async function isManagedProjectAsync(projectRoot) {
    try {
        await config_plugins_1.AndroidConfig.Paths.getProjectPathOrThrowAsync(projectRoot);
        return false;
    }
    catch {
        return true;
...
async function openUrlAsync({ url, device, isDetached = false, sdkVersion, devClient = false, exp, projectRoot, }) {
    ...
    try {
        ...
        if (devClient) {
            ...
            if (isManaged) {
                applicationId = (_a = exp === null || exp === void 0 ? void 0 : exp.android) === null || _a === void 0 ? void 0 : _a.package;
                if (!applicationId) {
                ...
                applicationId = await config_plugins_1.AndroidConfig.Package.getApplicationIdAsync(projectRoot);
                if (!applicationId) {
            ...
            const promptKey = (_b = device.pid) !== null && _b !== void 0 ? _b : 'unknown';
            if (!shouldInstall &&
