...
async function publishAsync(projectRoot, options = {}) {
    ...
    const androidBundle = (_b = bundles.android.hermesBytecodeBundle) !== null && _b !== void 0 ? _b : bundles.android.code;
    const iosBundle = (_c = bundles.ios.hermesBytecodeBundle) !== null && _c !== void 0 ? _c : bundles.ios.code;
    const hasHooks = validPostPublishHooks.length > 0;
    const androidSourceMap = hasHooks ? (_d = bundles.android.hermesSourcemap) !== null && _d !== void 0 ? _d : bundles.android.map : null;
    const iosSourceMap = hasHooks ? (_e = bundles.ios.hermesSourcemap) !== null && _e !== void 0 ? _e : bundles.ios.map : null;
    let response;
    try {
    ...
    if (validPostPublishHooks.length ||
        ((_f = exp.ios) === null || _f === void 0 ? void 0 : _f.publishManifestPath) ||
        ((_g = exp.android) === null || _g === void 0 ? void 0 : _g.publishManifestPath) ||
    ...
    await internal_1.EmbeddedAssets.configureAsync({
        ...
        pkg,
        exp,
        releaseChannel: (_h = options.releaseChannel) !== null && _h !== void 0 ? _h : 'default',
